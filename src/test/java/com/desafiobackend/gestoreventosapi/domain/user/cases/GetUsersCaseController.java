...
public class GetUsersCaseController {
    ...
    public void whenReturn200OK() {
        ...
        when(userService.getAll(UserDTO.class)).thenReturn(List.of(new UserDTO()));
    ...
    public void whenReturn404NotFound() {
        ...
        when(userService.getAll(UserDTO.class)).thenReturn(null);
