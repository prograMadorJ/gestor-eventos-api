...
public class DeleteCaseController {
    ...
    public void whenReturnStatus200OK() {
        ...
        when(eventService.delete(event.getId())).thenReturn(EventResponseMessages.DELETED);

        ResponseEntity response = eventController.deleteEvent(event.getId());
    ...
    public void whenReturnStatus404NotFound() {
        ...
        when(eventService.delete(event.getId())).thenReturn(EventResponseMessages.NOT_FOUND);
    ...
    public void whenReturnStatus500Error() {
        ...
        when(eventService.delete(event.getId())).thenReturn(EventResponseMessages.DELETE_ERROR);
